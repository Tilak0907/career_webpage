...
export const Footer: React.FC = () => {
  return (
    <footer className="w-full border-t border-slate-200 bg-white text-slate-600 mt-12 sm:mt-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 sm:gap-8 mb-6 sm:mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-xs text-slate-600">
              <li><Link href="/" className="hover:text-indigo-600 transition">Featured Companies</Link></li>
              <li><Link href="/" className="hover:text-indigo-600 transition">Explore Open Roles</Link></li>
              <li><Link href="/admin" className="hover:text-indigo-600 transition">Employer Admin Portal</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-xs text-slate-600">
              <li className="flex items-center gap-1">
                <a href="https://linkedin.com" target="_blank" rel="noreferrer" className="hover:text-indigo-600 transition">LinkedIn Career Tips</a>
                <ExternalLink className="w-3 h-3 text-slate-400" />
              </li>
              <li className="flex items-center gap-1">
                <a href="https://github.com" target="_blank" rel="noreferrer" className="hover:text-indigo-600 transition">Student Project Showcase</a>
                <ExternalLink className="w-3 h-3 text-slate-400" />
              </li>
